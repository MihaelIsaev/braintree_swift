...
public class SandboxValues {
    ...
    public enum Dispute: String {
        case chargeback = "4023898493988028"
    }
    
    public enum PaymentMethodNonce: String {
    ...
    public enum FailsVerification: String {
        case mastercard = "5105105105105100"
    }
    
    public enum TransactionAmount: Double { //or change to String?
